...
namespace capstone_backend.Models
{
    ...
    public partial class burgerdbEntities : DbContext
    {
        ...
        public virtual int update_product_inventory(Nullable<int> productid, string productname, Nullable<int> productquantity, Nullable<decimal> productprice, Nullable<decimal> producttotal, string productsupplier, string productimg, string productcategory, string pcode, Nullable<System.DateTime> expired, Nullable<int> state)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("update_product_inventory", productidParameter, productnameParameter, productquantityParameter, productpriceParameter, producttotalParameter, productsupplierParameter, productimgParameter, productcategoryParameter, pcodeParameter, expiredParameter, stateParameter);
        }
